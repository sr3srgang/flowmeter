...
class FlowLoop(QWidget):
    def __init__(self, name, input_device,loop_time):
        print("Initializing FlowLoop...")
        super(FlowLoop, self).__init__()
        
        self.input_device = input_device
        self.loop_time = loop_time

        print(f"Type of input_device: {type(self.input_device)}")
        print(f"Methods in input_device: {dir(self.input_device)}")
        ...
        self.df_path = "Users/srgang/Desktop/flowmeter/logs"
